...
export const fetchWeeklyTrends = async (token) => {
  ...
  const avgSleep = 0; // Skip sleep complex average for now to save network time
  const avgSpo2 = 0;
  
  return {
    avgHeartRate: avgHR,
    heartRateTrend: avgHR > 0 ? 0 : null, // Not enough historical data in 1 payload to do deep trend
    avgSteps: avgSteps,
    stepsTrend: null,
    avgSleepHours: avgSleep,
    sleepTrend: null,
    avgSpo2: avgSpo2,
    consistencyScore: avgSteps > 0 ? 80 : 0,
